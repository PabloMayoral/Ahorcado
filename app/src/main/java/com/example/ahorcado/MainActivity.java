...
public class MainActivity extends AppCompatActivity {
    ...
    String palabraOculta = escogePalabra();
    ...
    private String escogePalabra() {
        String[] listaPalabras = {"Fabio", "marica", "weon","coches","lloreria","bermejogay","msi","cancelado","fraxito","puebleo",
        "pokemongo","rodrigo","cars3","android","Ramiro"};
